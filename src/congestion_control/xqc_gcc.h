...
#ifndef _XQC_GCC_H_INCLUDED_
#define _XQC_GCC_H_INCLUDED_
...
typedef enum {
    GCC_DELAY_MODE = 0, /* to operate with copa's delay-based control */
    GCC_COMPETITIVE_MODE = 1, /* to co-exist with loss-based CCAs */
} xqc_gcc_mode_t;

typedef struct xqc_gcc_s {
    /* 
    ...
    xqc_gcc_direction_t curr_dir, prev_dir;
    ...
    xqc_usec_t           rate_time;
    xqc_usec_t           lost_time;
} xqc_gcc_t;

extern const xqc_cong_ctrl_callback_t xqc_gcc_cb;
